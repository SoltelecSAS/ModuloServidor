...
import com.soltelec.servidor.model.Schedules;
...
import com.soltelec.servidor.model.Pendingtasks;
import com.soltelec.servidor.model.Tasks;
import com.soltelec.servidor.model.Taskhistory;
...
public class SchedulesJpaController {
    ...
    public void create(Schedules schedules) throws PreexistingEntityException, Exception {
        ...
        try {
            ...
            Collection<Taskhistory> attachedTaskhistoryCollection = new ArrayList<Taskhistory>();
    ...
    public void edit(Schedules schedules) throws IllegalOrphanException, NonexistentEntityException, Exception {
        ...
        try {
            ...
            Collection<Taskhistory> attachedTaskhistoryCollectionNew = new ArrayList<Taskhistory>();
