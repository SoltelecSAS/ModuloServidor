...
public class RegistroFugas extends javax.swing.JInternalFrame {

    JFileChooser fc;
    JPanel componentPanel;
    JTitlePanel componentTitlePanel;
    private DefaultTableModel datosFugas;
    ...
    public RegistroFugas() {
        super("Reporte de verificación de fugas",
                true, //resizable
                true, //closable
                false, //maximizable
                true);
    ...
    private void iniciarModelo() {
        ...
        datosFugas = new DefaultTableModel();
        datosFugas.addColumn("Nombre equipo");                  //0
        datosFugas.addColumn("Serial equipo");  //1
        datosFugas.addColumn("PEF");                //2
        datosFugas.addColumn("Fecha");        //3
        datosFugas.addColumn("Usuario operario");        //4
        datosFugas.addColumn("Estado");

//---------- 
    }

    private void fillData(Date fInicial, Date fFinal) {
        List<Fugas> listaDatos = Reportes.getFugas(fInicial, fFinal);
        ...
        listaDatos.stream().forEach(datos->{
            ...
            datosFugas.addRow(fila);
        });

        tblDatos.setModel(datosFugas);
    ...
    private void initComponents() {
        ...
        tblDatos.setName("Registro fugas"); // NOI18N
        jScrollPane3.setViewportView(tblDatos);

        jTabbedPane1.addTab("Registro fugas", jScrollPane3);
