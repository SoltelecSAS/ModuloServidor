 ...
 */
public class ReportTabla6Equipos extends javax.swing.JInternalFrame {
     ...
     */
    public ReportTabla6Equipos() {
        super("Reporte Equipos Tabla 6 NTC",
                true, //resizable
                true, //closable
                false, //maximizable
                true);
...
//      ******MODELO EQUIPO******          
    ...
    private void fillData(Date fInicial, Date fFinal) {
        ...
        try {
            ...
            Object[] filaEquipo = new Object[13]; // Hay tres columnas en la tabla
            for (Object[] result : LstCal) {
                ...
                filaEquipo[4] = df.format(result[3]);                   //Valor gas referencia bajo  HC verificaciòn y ajuste 
                filaEquipo[5] = df.format(result[4]);                   //Valor gas referencia bajo CO verificaciòn y ajuste
                filaEquipo[6] = df.format(result[5]);                 //Valor gas referencia bajo CO2 verificaciòn y ajuste
                filaEquipo[7] = df.format(result[6]);                   //Valor gas referencia alto HC verificaciòn y ajuste
                filaEquipo[8] = df.format(result[7]);                   //Valor gas referencia  alto CO verificaciòn y ajuste
                filaEquipo[9] = df.format(result[8]);                 //Valor gas referencia  alto CO2 verificaciòn y ajuste
                filaEquipo[10] = new SimpleDateFormat("yyyy/MM/dd HH:mm").format(result[2]);    //Fecha de Version Software
