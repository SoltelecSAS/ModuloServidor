 ...
 * @author User
 */
public class ReporteCornare extends javax.swing.JInternalFrame {
...
//      ******Datos del Vehiculo****** 
        ...
        datosVehiculos.addColumn("Consecutivo prueba");
...
//         ******Resultados de la Prueba******
        ...
        resultadosPrueba.addColumn("No cilindros");
        ...
        datosEquipoAnalizadorVariable.addColumn("No. SERIE ANALIZADOR");
        datosEquipoAnalizadorVariable.addColumn("N° SERIE BANCO");
        datosEquipoAnalizadorVariable.addColumn("N° SERIE ELECTRONICO DEL ANALIZADOR");
    ...
    private void fillData(Date fInicial, Date fFinal) {
        ...
        datosVehiculosDTO.stream().forEach(datosVehiculo -> {
            Object[] fila = {
                ...
                datosVehiculo.getNumeroConsecutivoPrueba(),
        ...
        datosEquipoAnalizadorDTO.stream().forEach(equipo ->{
            Object [] fila ={
                ...
                equipo.getNSerieAnalizador(),
                equipo.getNSerieBanco(),
                equipo.getNSerieElectronicoAnalizador(),
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        ReporteTabla.setName("Reporte Cornare");
